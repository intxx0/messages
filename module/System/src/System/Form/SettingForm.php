<?php
/**
 * File for Modules Settings Form Class
 *
 * @category  ModuleSetting
 * @package   User_Form
	...
	public function __construct($serviceManager = null) {
		...
		foreach($resultSet as $module => $settings) {
			...
			foreach($settings as $setting) {
				...
				$options = array(
						'label' => $setting['label'] . ( $setting['description']?" {$setting['description']}":''),
				...
				switch($setting['type']) {
					...
					case '3':
						...
						$options['label_attributes']['class'] = 'mdl-checkbox mdl-js-checkbox mdl-js-ripple-effect';
						break;
					case '4':
					...
					case '7':
						...
						$type = 'Zend\Form\Element\Text';
						$attributes['class'] = 'mdl-textfield__input mdl-colorpicker';
						$options['label_attributes']['class'] = 'mdl-textfield__label mdl-suspended';
						
						break;
					case '8':
						$type = 'Zend\Form\Element\Text';
						$attributes['class'] = 'mdl-textfield__input material-timepicker';
						$attributes['pattern'] = '[0-9]{2}:[0-9]{2}:[0-9]{2}';
